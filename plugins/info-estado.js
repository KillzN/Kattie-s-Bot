...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  ${tradutor.texto1[1]} Kathy
  ${tradutor.texto1[2]} +573243446506
  ...
  const Message = {
    document: { url: `https://github.com/Kathy` },
    ...
    contextInfo: {
      ...
      isForwarded: true,
      externalAdReply: {
        mediaUrl: "https://github.com/Kathy",
        mediaType: 2,
        previewType: "pdf",
        title: "𝗞𝗮𝘁𝘁𝗶𝗲❜𝘀 𝗕𝗼𝘁",
        body: tradutor.texto2,
        thumbnail: imagen1,
        sourceUrl: "https://github.com/Kathy",
      },
    },
    caption: info,
    footer: wm,
