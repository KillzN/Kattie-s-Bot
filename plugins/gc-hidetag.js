//Código desarollado por Semi, https://wa.me/573243446506)
let handler = async(m, {conn, text, participants}) => {
  ...
  conn.sendMessage(m.chat, {text: text ? text : "@kattiesbot1", mentions: participants.map(u => conn.decodeJid(u.id))}, {quoted: m})
  }} else if (m.quoted) {
